...
<div class="col-xs-12">
    <div class="flexSection">
        ...
        <div class="inputSection postInput-section mapbox">
            ...
            <div class="row">
                <div class="col-sm-6">
                    <input type="text" class="form-control" value="{{ $model->location->lat ?? '' }}"
                        placeholder="latitude" id="map-lat" name="location[lat]">
                </div>
                <div class="col-sm-6">
                    <input type="text" class="form-control" value="{{ $model->location->lng ?? '' }}"
                        placeholder="longitude" id="map-lng" name="location[lng]">
                </div>
            </div>
            <input name="location[text]" value="{{ $model->location->text ?? '' }}" class="form-control openMap"
                id="map-location" placeholder="{{ __('Enter your location') }}">
...
<script>
    ...
    // Set the Map
    var itemlat = parseFloat("{{ $model->location->lat ?? '24.69023' }}");
    var itemlng = parseFloat("{{ $model->location->lng ?? '46.685' }}");
