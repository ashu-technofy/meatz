...
class AdminController extends HelperController
{
    ...
    protected function form_builder()
    {
        ...
        if (auth()->check()) {
            $this->inputs['featured'] = ['title' => 'مميز', 'type' => 'select', 'values' => boolean_vals()];
        }
        ...
        $this->inputs = array_merge($this->inputs, [
            'email' => ['title' => 'البريد الإلكترونى', 'type' => 'email'],
            'mobile' => ['title' => 'رقم الجوال', 'empty' => 1],
            'password' => ['title' => 'كلمة المرور', 'type' => 'password'],
            'supplier_code' => ['title' => 'MyFatoorah Supplier code'],
            'categories[]' => ['title' => 'الأقسام', 'type' => 'select', 'multiple' => 'multiple', 'values' => $cats],
            'days_off[]' => ['title' => 'العطلات', 'type' => 'select', 'values' => days_off(), 'multiple' => 'multiple' , 'empty' => 1],
            // 'working_to' => ['title' => 'ساعات العمل إلى', 'type' => 'select', 'values' => hours()],
            'google_map' => ['title' => 'رابط جوجل ماب', 'type' => 'text' , 'empty' => 1],
            'logo' => ['title' => 'اللوجو', 'type' => 'image'],
