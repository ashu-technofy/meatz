...
<head>
    ...
    <title>لوحة تحكم <?php echo e(app_setting('title')); ?></title>
    <?php echo $__env->yieldContent('head'); ?>
    <!-- bootstrap 4.0 -->
    <link rel="stylesheet"
        href="<?php echo e(url('/')); ?>/assets/admin/vendor_components/bootstrap/dist/css/bootstrap.min.css">
    <link rel="stylesheet"
        href="<?php echo e(url('/')); ?>/assets/admin/vendor_components/bootstrap/dist/css/bootstrap-extend.min.css">

    <!-- font awesome -->
    <link rel="stylesheet"
        href="<?php echo e(url('/')); ?>/assets/admin/vendor_components/font-awesome/css/font-awesome.min.css">
    <!-- theme style -->
    <link rel="stylesheet" href="<?php echo e(url('assets')); ?>/admin/css/master_style.css?ver=1.2">

    <link rel="icon" type="image/png" href="<?php echo e(app_setting('favicon')); ?>" />
    ...
    <link rel="stylesheet" href="<?php echo e(url('/')); ?>/assets/admin/vendor_components/select2/dist/css/select2.min.css">
    <link href="//cdn.jsdelivr.net/npm/summernote@0.8.18/dist/summernote-lite.min.css" rel="stylesheet">
    <link href="<?php echo e(url('/')); ?>/assets/admin/vendor_components/datatables/datatables.min.css" rel="stylesheet"
        type="text/css" />

    <link rel="stylesheet" href="<?php echo e(url('assets/admin/css')); ?>/custom.css?ver=1.112">
    <?php if(app()->getLocale() == 'en'): ?>
        <link rel="stylesheet" href="<?php echo e(url('assets/admin/css')); ?>/custom_en.css?ver=1.02">
    <?php endif; ?>
...
<body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
        ...
        <?php echo $__env->make('Common::admin.layout.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

        <?php if(!auth('stores')->check()): ?>
            <?php echo $__env->make('Common::admin.layout.side', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <?php endif; ?>


        <!-- Content Wrapper. Contains page content -->
        <div class="content-wrapper" id="mycontent" <?php if(auth('stores')->check()): ?> style="margin:0px;" <?php endif; ?>
            ...
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a class="mlink" href="<?php echo e(url('/admin')); ?>"><i
                                class="fa fa-dashboard"></i>
                            <?php echo app('translator')->get('Home'); ?></a></li>
                    <li class="breadcrumb-item active"><?php echo e(__($title)); ?></li>
                </ol>
            </section>
            <!-- Main content -->
        ...
        <!-- /.content-wrapper -->
        <footer class="main-footer" dir="<?php echo e(app()->getLocale() == 'ar' ? 'rtl' : 'ltr'); ?>">
    ...
    <script src="<?php echo e(url('/')); ?>/assets/admin/vendor_components/jquery-ui/jquery-ui.min.js"></script>
    ...
    <script src="<?php echo e(url('/')); ?>/assets/admin/vendor_components/select2/dist/js/select2.full.min.js"></script>
    <script src="<?php echo e(url('/')); ?>/assets/admin/vendor_components/datatables/datatables.min.js" type="text/javascript">
    </script>
    <script src="<?php echo e(url('/')); ?>/assets/admin/vendor_components/datatables/plugins/bootstrap/datatables.bootstrap.js"
    ...
    <!-- AdminLTE App -->
    <script src="<?php echo e(url('/')); ?>/assets/admin/js/template.js?ver=1.0"></script>
    <script src="<?php echo e(url('/')); ?>/assets/admin/js/demo.js?ver=1.0"></script>
    ...
    <script>
        ...
        $('body').on('submit', '.action_form', function() {
            ...
            if (form.hasClass('remove')) {
                Swal.fire({
                    text: "<?php echo e(__('Do you want to delete ?')); ?>",
                    icon: "warning",
        ...
        $('body').on('change', '#order_status', function() {
            ...
            $.get("<?php echo e(route('admin.orders.status')); ?>", {
                status: $(this).val(),
                order_id: order_id
            }, function(result) {
                Swal.fire({
        ...
        $(document).ready(function() {
            setInterval(() => {
                $.get("<?php echo e(route('admin.notfs_counter')); ?>", function(result) {
                    if (result.orders > 0) {
...
<?php /**PATH /home/u878064185/domains/testingjunction.tech/public_html/meatz/Modules/Common/Views/admin/layout/index.blade.php ENDPATH**/ ?>