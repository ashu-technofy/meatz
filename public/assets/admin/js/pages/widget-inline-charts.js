...
$(function () {
	...
	$("#sparkline5").sparkline([18, 22, 38, 20], {
        type: 'pie',
        height: '100',
        sliceColors: ['#0a89c1', '#33bf7a', '#7460ee', '#f95454'],
  ...
  function drawDocSparklines() {
    ...
    $('#compositebar').sparkline([7,3,10,5,4,8,6,4,2,4,5,3,4,5],
        {composite: true, fillColor: false, lineColor: '#f95454'});
    ...
    $('#linecustom').sparkline('html',
        {
          height: '1.5em', width: '8em', lineColor: '#f95454', fillColor: '#efb614',
    ...
    $('.sparktristatecols').sparkline('html',
        {type: 'tristate', colorMap: {'-2': '#0a89c1', '2': '#0a89c1'}});

    // Composite line charts, the second using values supplied via javascript
    $('#compositeline').sparkline('html', {fillColor: false, changeRangeMin: 0, chartRangeMax: 10});
    $('#compositeline').sparkline([7,3,10,5,4,8,6,4,2,4,5,3,4,5],
        {composite: true, fillColor: false, lineColor: '#f95454', changeRangeMin: 0, chartRangeMax: 10});
    ...
    $('.discrete1').sparkline('html',
        {type: 'discrete', lineColor: '#0a89c1', xwidth: 18});
    $('#discrete2').sparkline('html',
        {type: 'discrete', lineColor: '#0a89c1', thresholdColor: '#f95454', thresholdValue: 4});
